...
--
-- Host: localhost
-- Generation Time: Dec 15, 2022 at 10:29 AM
...
--
CREATE DATABASE IF NOT EXISTS `cybersecurity_awareness` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
(6, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(7, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(8, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,rajajinagar', 'Male');
...
(47, 'Naive Bayes', '54.77178423236515'),
(48, 'SVM', '54.77178423236515'),
(49, 'Logistic Regression', '54.77178423236515'),
(50, 'Decision Tree Classifier', '51.037344398340245'),
(51, 'Gradient Boosting Classifier', '50.20746887966805');
...
(7, 'Phishing Attacks', '50.0'),
(8, 'Social Engineering Attacks', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_awarness`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_awarness` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(300) NOT NULL,
  `Education_Level` varchar(300) NOT NULL,
  `Institution_Type` varchar(300) NOT NULL,
  `Attack_Date` varchar(300) NOT NULL,
  `Sex` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Device` varchar(300) NOT NULL,
  `IT_Student` varchar(300) NOT NULL,
  `Location` varchar(300) NOT NULL,
  `Internet_Type` varchar(300) NOT NULL,
  `Network_Type` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_awarness`
--

INSERT INTO `remote_user_predict_awarness` (`id`, `RID`, `Education_Level`, `Institution_Type`, `Attack_Date`, `Sex`, `Age`, `Device`, `IT_Student`, `Location`, `Internet_Type`, `Network_Type`, `Url`, `Prediction`) VALUES
(1, '10.42.0.42-40.127.169.165-59453-443-6', 'School', 'private', '08-10-20', 'Female', '18', 'Mobile', 'No', 'Town', 'Mobile Data', '3G', 'https://www.cybersafe.news/fbi-warns-about-iranian-hacking-group-attacking-f5-networking-devices/\r\n', 'Phishing Attacks'),
(4, '10.42.0.211-77.234.44.79-52881-443-6', 'School', 'Private', '1/21/2020', 'Male', '11', 'Mobile', 'No', 'Town', 'Mobile Data', '3G', 'https://www.nytimes.com/2020/01/22/world/middleeast/bezos-phone-hacked.html\r\n', 'Social Engineering Attacks');
